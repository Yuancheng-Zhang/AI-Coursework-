...
Question: Using 4 clusters for source IP addresses (split them at up to 20 records, 21 - 200, 201 - 400, > 400) 
and 4 clusters for destination IP addresses (split them at up to 40 records, 41 - 100, 101 - 400, > 400), investigate 
the relation between source and destination - for example, does source-cluster 1 always contact a destination in destination cluster 3? 
Can you determine conditional probabilities? Can you illustrate this graphically?
"""
...
###############################################################################
"Cluster the Dest and Source IPs according to the Number of Occurrence."
...
"Cluster the Source IPs according to the Number of Occurrence."
ks = range(0, len(s))
for k in ks:
    if s[k][1] <= 20:
        s1 += 1
...
ssum = s1 + s2 + s3 + s4
print('SourceIP Cluster Number')
print(s1, s2, s3, s4)
# print(sf)
# print(ss)
# print(st)
# print(sh)
print('Probability of SourceIP Cluster 1: ', s1 / ssum )
print('Probability of SourceIP Cluster 2: ', s2 / ssum )
print('Probability of SourceIP Cluster 3: ', s3 / ssum )
print('Probability of SourceIP Cluster 4: ', s4 / ssum )
print('.............................................................................................')

###############################################################################

"Cluster the Dest IPs according to the Number of Occurrence."
kd = range(0, len(d))
for k in kd:
    if d[k][1] <= 40:
        d1 += 1
...
dsum = d1 + d2 + d3 + d4
print('DestIP Cluster Number')
print(d1, d2, d3, d4)
# print(df)
# print(ds)
# print(dt)
# print(dh)
print('Probability of DestIP Cluster 1: ', d1 / dsum )
print('Probability of DestIP Cluster 2: ', d2 / dsum )
print('Probability of DestIP Cluster 3: ', d3 / dsum )
print('Probability of DestIP Cluster 4: ', d4 / dsum )

print('.............................................................................................')


#%%
"Find the relationship between Dest and Source IPs clusters."

def S_D(SIP):
    "Calculate the Conditional Probability of Source in Dest."
    M = range(0, len(SIP))
    ...
    for m in M:
        "Find the match in DestIP"
        Find = findElements(destip, index[m])
        F.append(Find)
...
def D_S(DIP):
    "Calculate the Conditional Probability of Dest in Source."
    M = range(0, len(DIP))
    index = []
    F = []
    for m in M:
    ...
    for m in M:
        "Find the match in SourceIP"
        Find = findElements(sourceip, index[m])
        F.append(Find)
...
SDPlot = {
    ...
    'SourceIP Cluster 2': S_D(ss),
    'SourceIP Cluster 3': S_D(st),
    'SourceIP Cluster 4': S_D(sh)
    }
DSPlot = {
...
#%%
"Plot the relationship between Source and Dest IP Clusters."
HSB(SDPlot, SDnames)
HSB(DSPlot, DSnames)
plt.show()
